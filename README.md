...
Minimal, production-ready **CPU-only** ComfyUI image for Railway. Installs ComfyUI from GitHub and pre-installs **ComfyUI-Manager** (based on the YanWenKun/ComfyUI-Docker `/cpu` approach).
